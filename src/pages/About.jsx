...
export default function About() {
  ...
  return (
    <div>
      <section className="pt-32 pb-16 md:pt-40 md:pb-20 max-w-7xl mx-auto px-5 md:px-8">
        <motion.p
        ...
        <h1 className="font-display text-5xl md:text-7xl uppercase leading-[0.95] max-w-3xl">
        ...
        <motion.p
          ...
          className="text-muted text-base md:text-lg leading-relaxed max-w-2xl mt-8"
        >
          {hero.subtitle}
        </motion.p>
      </section>
