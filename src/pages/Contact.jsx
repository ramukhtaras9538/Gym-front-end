...
export default function Contact() {
  ...
  const { hero, contactInfo, hours } = content;
  ...
  function handleSubmit(e) {
    e.preventDefault();
    // Wire this up to your own inbox/CRM endpoint — this is a UI-only stub
    // separate from the content API, since enquiries aren't page content.
    setSent(true);
  }
